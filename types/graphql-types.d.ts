...
export type WorksPageQueryVariables = Exact<{ [key: string]: never; }>;


export type WorksPageQuery = { allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id' | 'excerpt'>
        & { frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title'>
          & { featuredImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, tags?: Maybe<Array<Maybe<Pick<MarkdownRemarkFrontmatterTags, 'name' | 'color'>>>> }
        )>, fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
      ) }> }
  ) };

export type WorkDetailPageQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


export type WorkDetailPageQuery = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'link'>
      & { tags?: Maybe<Array<Maybe<Pick<MarkdownRemarkFrontmatterTags, 'name' | 'color'>>>>, featuredImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
    )> }
  )> };
